  ...
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
     ...
     <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="number" name="num_documento" id="num_documento" min="1" maxlength="11" required placeholder="Número de Documento">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="number" name="telefono" id="telefono" maxlength="9" min="1" pattern="^[0-9]+" required  placeholder="Número de Telefono">
    </div>
        <div class="form-group col-lg-6 col-md-6 col-xs-12">
