...
$sql="delete from detalle_ingreso where idingreso in (select idingreso from ingreso where idproveedor = {$idpersona})";
 ejecutarConsulta($sql);
 $sql="delete from detalle_venta where idventa in (select idventa from venta where idcliente = {$idpersona})";
 ejecutarConsulta($sql);
         $sql ="delete from venta where idcliente={$idpersona};";
         ejecutarConsulta($sql);
        $sql ="delete from ingreso where idproveedor={$idpersona};";
         ejecutarConsulta($sql);
