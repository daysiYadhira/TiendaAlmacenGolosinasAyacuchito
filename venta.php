...
<div class="panel-body" style="height: 400px;" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-2 col-md-2 col-xs-6">
      ...
      <input class="form-control" type="number" name="impuesto" id="impuesto" min="0" pattern="^[0-3]+" required>
    </div>
...
require 'footer.php';
 ?>
  <script src="../public/js/sweetalert2.min.js" type="text/javascript"></script>
