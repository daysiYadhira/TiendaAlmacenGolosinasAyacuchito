...
<div class="panel-body" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input type="number" class="form-control" name="num_documento" id="num_documento" min="1" maxlength="11"  required placeholder="Documento" maxlength="20">
    </div>
       <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="text" name="telefono" id="telefono" maxlength="9" min="1" pattern="^[0-9]+" required placeholder="Número de telefono">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
...
require 'footer.php';
 ?>
<script src="../public/js/sweetalert2@9.js" type="text/javascript"></script>
